export default class ContentExample {
	static lists = ['Shopping', 'Movies to watch', 'Places to visit', 'Great ideas!'];
	...
	static placesToVisit = ['Amsterdam', 'Berlin', 'Madrid', 'Rome', 'London', 'Paris', 'Prague', 'Stockholm', 'Vienna'];

	static moviesToWatch = [
